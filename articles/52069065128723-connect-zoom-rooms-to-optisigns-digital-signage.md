...
For full details on the Zoom permissions (scopes) OptiSigns uses, how to add or remove the app, and what happens to your data after removal, see [OptiSigns Digital Signage App for Zoom — Adding, Using, and Removing the App](./52523606879251-optisigns-digital-signage-app-for-zoom-adding-using-and-removing-the-app.md).
